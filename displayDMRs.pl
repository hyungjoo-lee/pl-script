...
@sorted = sort { $h_0{$a}<=>$h_0{$b} or $h_1{$a}<=>$h_1{$b} or $h_2{$a}<=>$h_2{$b} or $h_3{$a}<=>$h_3{$b} or $h_4{$a}<=>$h_4{$b} or $h_5{$a}<=>$h_5{$b} or $h_6{$a}<=>$h_6{$b} or $h_7{$a}<=>$h_7{$b} or $h_8{$a}<=>$h_8{$b} or $h_9{$a}<=>$h_9{$b} } @status ;
